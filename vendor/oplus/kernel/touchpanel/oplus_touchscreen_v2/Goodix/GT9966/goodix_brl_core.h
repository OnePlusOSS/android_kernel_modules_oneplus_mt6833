...
#define GOODIX_CORE_DRIVER_NAME		    "goodix-gt9966"
...
/* step 1 vibrator*/
#define PEN_CTL_VIBRATOR 0x02
#define PEN_CTL_VIBRATOR_ENABLE 0x01
...
struct chip_data_brl {
	...
	unsigned int                        game_now_state;
	unsigned int                        game_old_state;
	unsigned int                        game_chg_state;
